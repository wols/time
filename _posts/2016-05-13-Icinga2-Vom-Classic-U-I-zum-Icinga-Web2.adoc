...
.Icinga2 Core mit ClassicUI - Startansicht
...
Im Vergleich fällt auf: Nicht nur die Host-Probleme sind sichtbar, auch die zugehörigen Service.

.Icinga2 Core mit IcingaWeb2 - Dashboard
