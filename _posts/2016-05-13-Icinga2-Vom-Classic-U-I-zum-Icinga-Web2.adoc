...
== Host-Problem bestätigt

Der Kommentar beim bestätigen lautete "Problem via Icinga Web2 bestätigt".
...
image::https://wols.github.io/time/images/2016/05/13/03-icinga2.png[Icinga2 Core mit Icinga Web 2 - Dashboard, link="https://wols.github.io/time/images/2016/05/13/04-icinga1.png"]